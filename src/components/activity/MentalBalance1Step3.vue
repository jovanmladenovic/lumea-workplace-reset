<script setup lang="ts">
  ...
  const messages = [
    {
      text: `Look in the mirror and say to yourself: `,
      class: 'text-xl px-[140px]',
    },
    {
      text: `“I choose calm. I invite clarity in all my decisions today.”`,
...
<template>
  <ActivityStep ref="stepRef" step="3/5" title="Mental Refresh">
    ...
    <img ref="pulseCircleRef" class="w-full" src="/images/pulse-circle-2.png" alt="Pulse Circle" />
  </ActivityStep>
</template>
