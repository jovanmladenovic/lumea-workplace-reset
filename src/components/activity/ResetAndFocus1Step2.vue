<script setup lang="ts">
  ...
  import Breathe3 from '@/components/activity/Breathe3.vue';
  ...
  const breatheRef = ref<InstanceType<typeof Breathe3>>();
...
<template>
  <ActivityStep ref="stepRef" step="2/5" title="Breathing Reset">
