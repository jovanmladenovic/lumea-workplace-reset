<script setup lang="ts">
  ...
  import EnergyBoostStep2 from '@/components/activity/EnergyBoost1Step2.vue';
  import EnergyBoostStep3 from '@/components/activity/EnergyBoost1Step3.vue';
  import EnergyBoostStep4 from '@/components/activity/EnergyBoost1Step4.vue';
  import EnergyBoostStep5 from '@/components/activity/EnergyBoost1Step5.vue';
  ...
  const introMessages: { text: string; class?: string }[] = [
    {
      text: 'It’s time to unlock your energy.',
      class: 'text-xl px-[140px]',
    },
    {
      text: 'Let’s tap into your <b>strength</b> and <b>personal power</b>.',
      class: 'text-xl px-[140px]',
    },
  ];
