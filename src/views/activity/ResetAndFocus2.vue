<script setup lang="ts">
  ...
  import ResetAndFocus2Step2 from '@/components/activity/ResetAndFocus2Step2.vue';
  import ResetAndFocus2Step3 from '@/components/activity/ResetAndFocus2Step3.vue';
  import ResetAndFocus2Step4 from '@/components/activity/ResetAndFocus2Step4.vue';
  import ResetAndFocus2Step5 from '@/components/activity/ResetAndFocus2Step5.vue';
  ...
  const step2Ref = ref<InstanceType<typeof ResetAndFocus2Step2>>();
  const step3Ref = ref<InstanceType<typeof ResetAndFocus2Step3>>();
  const step4Ref = ref<InstanceType<typeof ResetAndFocus2Step4>>();
  const step5Ref = ref<InstanceType<typeof ResetAndFocus2Step5>>();
  ...
  const introMessages: { text: string; class?: string }[] = [
    ...
    {
      text: 'That’s your signal to shift gears and <b>spark new ideas</b>.',
      class: 'text-xl px-[140px]',
    },
    {
      text: 'Let’s <b>wake up your creativity</b> together.',
      class: 'text-xl px-[140px]',
    },
  ];
  ...
  const initStep5 = () => {
    return createCancellableSequence([
      () => blobsBackgroundRef.value?.setBackgroundColor('#B589D1'),
...
<template>
  <DefaultLayout>
    ...
    <div class="relative z-10 text-black">
      ...
      <ResetAndFocus2Step2 v-if="showStep2" ref="step2Ref" />
      <ResetAndFocus2Step3 v-if="showStep3" ref="step3Ref" />
      <ResetAndFocus2Step4 v-if="showStep4" ref="step4Ref" />
      <ResetAndFocus2Step5 v-if="showStep5" ref="step5Ref" />
    </div>
  </DefaultLayout>
</template>
